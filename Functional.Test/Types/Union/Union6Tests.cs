...
public class Union6Tests
{
    ...
    new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix>(new TypeOne())
        .Match(
            _ => "type one",
            _ => "type two",
            _ => "type three",
    ...
    public void ItShouldMatchCase2() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix>(new TypeTwo())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase3() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix>(new TypeThree())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase4() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix>(new TypeFour())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase5() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix>(new TypeFive())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase6() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix>(new TypeSix())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
