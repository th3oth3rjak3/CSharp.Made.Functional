...
public class Union7Tests
{
    ...
    public void ItShouldMatchCase1() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeOne())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase2() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeTwo())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase3() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeThree())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase4() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeFour())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase5() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeFive())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase6() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeSix())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase7() =>
        new Union<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven>(new TypeSeven())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
