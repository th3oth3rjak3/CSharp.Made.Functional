...
public class Union8Tests
{
    ...
    public void ItShouldMatchCase1() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeOne())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase2() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeTwo())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase3() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeThree())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase4() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeFour())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase5() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeFive())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase6() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeSix())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase7() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeSeven())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
    ...
    public void ItShouldMatchCase8() =>
        new Union8<TypeOne, TypeTwo, TypeThree, TypeFour, TypeFive, TypeSix, TypeSeven, TypeEight>(new TypeEight())
            .Match(
                _ => "type one",
                _ => "type two",
                _ => "type three",
