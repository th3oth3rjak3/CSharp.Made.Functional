...
public sealed record Union<A, B, C>
{
    /// <summary>
    ...
    public T Match<T>(Func<A, T> whenA, Func<B, T> whenB, Func<C, T> whenC)
    {
    ...
    public Unit Effect(Action<A> whenA, Action<B> whenB, Action<C> whenC)
    {
